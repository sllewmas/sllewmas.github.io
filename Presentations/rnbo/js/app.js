...
async function setup() {
    ...
    const response = await fetch("export/wells-granular.rnbopat.export.json");
...
function makeBufferSelector(device) {
    ...
    //     let label = document.createElement("label");
    //     label.innerText = desc.id;
    //     buffForm.appendChild(label);


    //     //buffRadio.setAttribute()
    // } else {
